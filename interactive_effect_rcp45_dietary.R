...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp45.both, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_insectivourous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp45.cl, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_insectivourous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
sr.2050.both <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',x,'_insectivourous.tif'))
})
batsr.2050.both.median <- overlay(stack(sr.2050.both), fun=median)

sr.2050.cl <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',x,'_insectivourous.tif'))
})
batsr.2050.cl.median <- overlay(stack(sr.2050.cl), fun=median)
writeRaster(batsr.2050.both.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_insectivourous.tif',format='GTiff',overwrite=T)
writeRaster(batsr.2050.cl.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_insectivourous.tif',format='GTiff',overwrite=T)
writeRaster(batsr.lc.rcp45,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_insectivourous.tif',format='GTiff',overwrite=T)
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.both.rcp45 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_insectivourous.tif'))
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.cl.rcp45 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_insectivourous.tif'))
...
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp45_insectivores.xlsx')
write.xlsx(sum.cl.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp45_insectivores.xlsx')
write.xlsx(sum.lc.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp45_insectivores.xlsx')


#plot maps species richness change
batsr.current <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_current_insectivourous.tif')
batsr.2050.both <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_insectivourous.tif')
batsr.2050.cl <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_insectivourous.tif')
batsr.2050.lc <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_insectivourous.tif')
...
tmap_save(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/current and srchange rcp45_insectivourous.tiff',
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp45, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_add_',gcm,'_insectivourous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){  
  batsr.2050.cl <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_insectivourous.tif'))
  batsr.2050.both <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_insectivourous.tif'))
  batsr.2050.add <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_add_',gcm,'_insectivourous.tif'))
  ...
  sr.interaction[batsr.2050.cl == batsr.current & batsr.lc.rcp45 == batsr.current &
                   batsr.2050.both > batsr.2050.add] <- 5
  writeRaster(sr.interaction, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',gcm,'_insectivourous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  sr.interaction <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',gcm,'_insectivourous.tif'))*area.withlcchange
...
sum.both.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp45_insectivores.xlsx')[2:5]
sum.cl.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp45_insectivores.xlsx')[2:5]
sum.lc.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp45_insectivores.xlsx')[2:3]
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_interaction_bar_rcp45_insectivores.tiff', 
...
sr.interaction <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',x,'_insectivourous.tif'))
})
...
tmap_save(figure.map, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/interaction_sr_rcp45_insectivourous.tiff',width = 8, height = 10, units = 'cm',dpi = 300)
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/rangesize_change_interaction_rcp45_insectivores.tiff',
       units = 'cm', width = 28, height = 8, dpi = 300)


#INTERACTIVE EFECT ON frugivorous SPECIES
vn.raster <- raster('F:/Working/2018/PhD_research/SDM output R/Map/vn raster.tif') #import Vietnam
species.list <- read.xlsx("F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/vnbats_habitat_traits.xlsx", sheetName = 'Sheet1')
species.list <- species.list%>%select(familyName,Scientific_name,Forest,Shrubland,Grassland,Wetlands,Artificial,Diet.Plant,Diet.Invertebrate)
species.list <- species.list%>%filter(familyName=='PTEROPODIDAE')
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp45.both <- overlay(stack(sr.2050.rcp45.both),fun=sum)
  writeRaster(batsr.2050.rcp45.both, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_frugivorous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
#climate change only model
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp45.cl <- overlay(stack(sr.2050.rcp45.cl),fun=sum)
  writeRaster(batsr.2050.rcp45.cl, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_frugivorous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
#land-cover change only models
sr.2050.rcp45.lc <- lapply(species.list$Scientific_name, function(sp){
...
gcm <- c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')
sr.2050.both <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',x,'_frugivorous.tif'))
})
batsr.2050.both.median <- overlay(stack(sr.2050.both), fun=median)

sr.2050.cl <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',x,'_frugivorous.tif'))
})
batsr.2050.cl.median <- overlay(stack(sr.2050.cl), fun=median)
writeRaster(batsr.2050.both.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_frugivorous.tif',format='GTiff',overwrite=T)
writeRaster(batsr.2050.cl.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_frugivorous.tif',format='GTiff',overwrite=T)
writeRaster(batsr.lc.rcp45,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_frugivorous.tif',format='GTiff',overwrite=T)
...
batsr.lc.rcp45 <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_frugivorous.tif')
vn.raster <- raster('F:/Working/2018/PhD_research/SDM output R/Map/vn raster.tif') #import Vietnam
batsr.lc.rcp45.current <- (batsr.lc.rcp45 - batsr.current)/batsr.current*100
pro.lc.rcp45 <- c(cellStats(batsr.lc.rcp45.current>=30,'sum')/cellStats(vn.raster,'sum')*100, 
                  cellStats(batsr.lc.rcp45.current < 30 & batsr.lc.rcp45.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
...
#effect of combined change
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.both.rcp45 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_frugivorous.tif'))
  batsr.both.rcp45.current <- (batsr.both.rcp45 - batsr.current)/batsr.current*100
  pro.both.rcp45 <- c(cellStats(batsr.both.rcp45.current>=30,'sum')/cellStats(vn.raster,'sum')*100,
                      cellStats(batsr.both.rcp45.current < 30 & batsr.both.rcp45.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
                      cellStats(batsr.both.rcp45.current == 0,'sum')/cellStats(vn.raster,'sum')*100,
...
#effect of climate change only
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.cl.rcp45 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_frugivorous.tif'))
  batsr.cl.rcp45.current <- (batsr.cl.rcp45 - batsr.current)/batsr.current*100
  pro.cl.rcp45 <- c(cellStats(batsr.cl.rcp45.current>=30,'sum')/cellStats(vn.raster,'sum')*100,
                    cellStats(batsr.cl.rcp45.current < 30 & batsr.cl.rcp45.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
                    cellStats(batsr.cl.rcp45.current == 0,'sum')/cellStats(vn.raster,'sum')*100,
...
sum.cl.sr$class <- factor(sum.cl.sr$class, levels = c('<-30','-30~0','0','0~30','>30'))
sum.lc.sr$class <- factor(sum.lc.sr$class, levels = c('<-30','-30~0','0','0~30','>30'))
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp45_frugivores.xlsx')
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp45_frugivores.xlsx')
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp45_frugivores.xlsx')


#plot maps species richness change
batsr.current <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_current_frugivorous.tif')
batsr.2050.both <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_frugivorous.tif')
batsr.2050.cl <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_frugivorous.tif')
batsr.2050.lc <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_frugivorous.tif')
SR.ORG8287 <- CRS('+proj=cea +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs')
vn <- spTransform(getData('GADM', country='VN', level=0), SR.ORG8287)
paracell.islands <- spTransform(readOGR('F:/Working/2018/PhD_research/SDM output R/Map/paracel islands.shp'), SR.ORG8287)
spratly.islands <- spTransform(readOGR('F:/Working/2018/PhD_research/SDM output R/Map/spratly islands.shp'), SR.ORG8287)
...
plot.srchange.rcp45.lc <-  tm_shape(batsr.lc.current, bbox = c(11380000, 930000,12450000,  2517140)) + 
  ...
  tm_layout(title = '(d) Land cover change only', title.size = 1, title.position = c('left','top'), frame = F, legend.show = F)
figure <- tmap_arrange(plot.current,plot.srchange.rcp45.both,plot.srchange.rcp45.cl,plot.srchange.rcp45.lc, nrow = 1)
tmap_save(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/current and srchange rcp45_frugivorous.tiff',
          units = 'cm', width = 24, height = 11, dpi=300)
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp45 <- overlay(stack(sp.2050.rcp45.add),fun=sum)
  writeRaster(batsr.2050.rcp45, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_add_',gcm,'_frugivorous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){  
  batsr.2050.cl <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_',gcm,'_frugivorous.tif'))
  batsr.2050.both <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_',gcm,'_frugivorous.tif'))
  batsr.2050.add <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_add_',gcm,'_frugivorous.tif'))
  sr.interaction <- batsr.current*0
  #two negative and negative neutral
  sr.interaction[batsr.2050.cl <= batsr.current & batsr.lc.rcp45 <= batsr.current & (batsr.2050.cl + batsr.lc.rcp45 != 2* batsr.current)&
                   batsr.2050.both < batsr.2050.add] <- 1
  ...
  sr.interaction[batsr.2050.cl == batsr.current & batsr.lc.rcp45 == batsr.current &
                   batsr.2050.both > batsr.2050.add] <- 5
  writeRaster(sr.interaction, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',gcm,'_frugivorous.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
area.withlcchange.area <- cellStats(area.withlcchange, 'sum')
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  sr.interaction <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',gcm,'_frugivorous.tif'))*area.withlcchange
  pro.interaction <- c(cellStats(sr.interaction==1,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==2,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==3,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==4,'sum')/area.withlcchange.area*100,
...
sum.both.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp45_frugivores.xlsx')[2:5]
sum.cl.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp45_frugivores.xlsx')[2:5]
sum.lc.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp45_frugivores.xlsx')[2:3]
names(sum.both.sr) <- c('class','pro.both.median','pro.both.min','pro.both.max')
names(sum.cl.sr) <- c('class','pro.cl.median','pro.cl.min','pro.cl.max')
...
figure <- ggarrange(figure.bar.both,figure.bar.cl,figure.bar.lc,figure.interaction,nrow = 1)
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_interaction_bar_rcp45_frugivores.tiff', 
       units = 'cm', width = 30, height = 8, dpi=300)
...
gcm <- c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')
sr.interaction <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp45_',x,'_frugivorous.tif'))
})
select.major <- function(x){
  modal(x, na.rm=T, freq=F, ties='random')
}
...
figure.map <- tm_shape(sr.interaction.ensemble,bbox = c(11070729, 943456.3,12186081,  2517140)) +
  ...
  # tm_shape(pas) + tm_polygons(col = 'green', alpha = 0,border.col = 'darkgreen')+
  tm_layout(title = '',title.position = c(0,0.95),legend.position = c(0.1,0.5), frame = F)
tmap_save(figure.map, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/interaction_sr_rcp45_frugivorous.tiff',width = 8, height = 10, units = 'cm',dpi = 300)
...
figure.interaction <- sum.range.interaction%>%ggplot(aes(x=factor(class,levels = c('-S','+A','AD','-A','+S')),y=pro.range.interaction.median,fill=class))+
  ...
  theme(text = element_text(size = 14), legend.position = 'none', axis.text = element_text(size = 14))
figure <- ggarrange(figure.both, figure.cl, figure.lc,figure.interaction,nrow = 1)
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/rangesize_change_interaction_rcp45_frugivores.tiff',
       units = 'cm', width = 28, height = 8, dpi = 300)
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/area change_dietary_rcp45.tiff',
...
batsr.2050.both.insectivourous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_insectivourous.tif')
batsr.2050.cl.insectivourous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_insectivourous.tif')
batsr.2050.lc.insectivourous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_insectivourous.tif')*area.withlcchange
...
batsr.2050.both.frugivorous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_both_median_frugivorous.tif')
batsr.2050.cl.frugivorous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_cl_median_frugivorous.tif')
batsr.2050.lc.frugivorous <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp45_lc_frugivorous.tif')*area.withlcchange
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_dietary_rcp45.tiff',
