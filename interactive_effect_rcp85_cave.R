...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp85.both, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp85.cl, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
sr.2050.both <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',x,'_cave.tif'))
})
batsr.2050.both.median <- overlay(stack(sr.2050.both), fun=median)

sr.2050.cl <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',x,'_cave.tif'))
})
batsr.2050.cl.median <- overlay(stack(sr.2050.cl), fun=median)
writeRaster(batsr.2050.both.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_cave.tif',format='GTiff',overwrite=T)
writeRaster(batsr.2050.cl.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_cave.tif',format='GTiff',overwrite=T)
writeRaster(batsr.lc.rcp85,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_cave.tif',format='GTiff',overwrite=T)
...
batsr.lc.rcp85 <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_cave.tif')
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.both.rcp85 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_cave.tif'))
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.cl.rcp85 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_cave.tif'))
...
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp85_cave.xlsx')
write.xlsx(sum.cl.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp85_cave.xlsx')
write.xlsx(sum.lc.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp85_cave.xlsx')

#plot maps species richness change
batsr.current <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_current_cave.tif')
batsr.2050.both <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_cave.tif')
batsr.2050.cl <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_cave.tif')
batsr.2050.lc <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_cave.tif')
...
tmap_save(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/current and srchange rcp85_cave.tiff',
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  writeRaster(batsr.2050.rcp85, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_add_',gcm,'_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
batsr.lc.rcp85 <- batsr.lc.rcp85
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){  
  batsr.2050.cl <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_cave.tif'))
  batsr.2050.both <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_cave.tif'))
  batsr.2050.add <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_add_',gcm,'_cave.tif'))
  ...
  sr.interaction[batsr.2050.cl == batsr.current & batsr.lc.rcp85 == batsr.current &
                   batsr.2050.both > batsr.2050.add] <- 5
  writeRaster(sr.interaction, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp85_',gcm,'_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_interaction_bar_rcp85_cave.tiff', 
...
sr.interaction <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp85_',x,'_cave.tif'))
})
...
tmap_save(figure.map, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/interaction_sr_rcp85_cave.tiff',width = 8, height = 10, units = 'cm',dpi = 300)
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/rangesize_change_interaction_rcp85_cave.tiff',
...
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp85.both <- overlay(stack(sr.2050.rcp85.both),fun=sum)
  writeRaster(batsr.2050.rcp85.both, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_no_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
#climate change only model
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp85.cl <- overlay(stack(sr.2050.rcp85.cl),fun=sum)
  writeRaster(batsr.2050.rcp85.cl, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_no_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
#land-cover change only models
sr.2050.rcp85.lc <- lapply(species.list$Scientific_name, function(sp){
...
gcm <- c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')
sr.2050.both <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',x,'_no_cave.tif'))
})
batsr.2050.both.median <- overlay(stack(sr.2050.both), fun=median)

sr.2050.cl <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',x,'_no_cave.tif'))
})
batsr.2050.cl.median <- overlay(stack(sr.2050.cl), fun=median)
writeRaster(batsr.2050.both.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_no_cave.tif',format='GTiff',overwrite=T)
writeRaster(batsr.2050.cl.median,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_no_cave.tif',format='GTiff',overwrite=T)
writeRaster(batsr.lc.rcp85,filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_no_cave.tif',format='GTiff',overwrite=T)
...
batsr.lc.rcp85 <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_no_cave.tif')
batsr.lc.rcp85.current <- (batsr.lc.rcp85 - batsr.current)/batsr.current*100
pro.lc.rcp85 <- c(cellStats(batsr.lc.rcp85.current>=30,'sum')/cellStats(vn.raster,'sum')*100, 
                  cellStats(batsr.lc.rcp85.current < 30 & batsr.lc.rcp85.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
                  cellStats(batsr.lc.rcp85.current == 0,'sum')/cellStats(vn.raster,'sum')*100,
...
#effect of combined change
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.both.rcp85 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_no_cave.tif'))
  batsr.both.rcp85.current <- (batsr.both.rcp85 - batsr.current)/batsr.current*100
  pro.both.rcp85 <- c(cellStats(batsr.both.rcp85.current>=30,'sum')/cellStats(vn.raster,'sum')*100,
                      cellStats(batsr.both.rcp85.current < 30 & batsr.both.rcp85.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
                      cellStats(batsr.both.rcp85.current == 0,'sum')/cellStats(vn.raster,'sum')*100,
...
#effect of climate change only
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  batsr.cl.rcp85 <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_no_cave.tif'))
  batsr.cl.rcp85.current <- (batsr.cl.rcp85 - batsr.current)/batsr.current*100
  pro.cl.rcp85 <- c(cellStats(batsr.cl.rcp85.current>=30,'sum')/cellStats(vn.raster,'sum')*100,
                    cellStats(batsr.cl.rcp85.current < 30 & batsr.cl.rcp85.current > 0,'sum')/cellStats(vn.raster,'sum')*100,
                    cellStats(batsr.cl.rcp85.current == 0,'sum')/cellStats(vn.raster,'sum')*100,
...
write.xlsx(sum.both.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp85_no_cave.xlsx')
write.xlsx(sum.cl.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp85_no_cave.xlsx')
write.xlsx(sum.lc.sr,'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp85_no_cave.xlsx')

#plot maps species richness change
batsr.current <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_current_no_cave.tif')
batsr.2050.both <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_no_cave.tif')
batsr.2050.cl <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_no_cave.tif')
batsr.2050.lc <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_no_cave.tif')
SR.ORG8287 <- CRS('+proj=cea +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs')
vn <- spTransform(getData('GADM', country='VN', level=0), SR.ORG8287)
paracell.islands <- spTransform(readOGR('F:/Working/2018/PhD_research/SDM output R/Map/paracel islands.shp'), SR.ORG8287)
spratly.islands <- spTransform(readOGR('F:/Working/2018/PhD_research/SDM output R/Map/spratly islands.shp'), SR.ORG8287)
...
plot.srchange.rcp85.lc <-  tm_shape(batsr.lc.current, bbox = c(11380000, 930000,12450000,  2517140)) + 
  ...
  tm_layout(title = '(d) Land cover change only', title.size = 1, title.position = c('left','top'), frame = F, legend.show = F)
figure <- tmap_arrange(plot.current,plot.srchange.rcp85.both,plot.srchange.rcp85.cl,plot.srchange.rcp85.lc, nrow = 1)
tmap_save(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/current and srchange rcp85_no_cave.tiff',
          units = 'cm', width = 24, height = 11, dpi=300)
#classify interaction effects
#additive species richness for each GCMs
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  ...
  batsr.2050.rcp85 <- overlay(stack(sp.2050.rcp85.add),fun=sum)
  writeRaster(batsr.2050.rcp85, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_add_',gcm,'_no_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){  
  batsr.2050.cl <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_',gcm,'_no_cave.tif'))
  batsr.2050.both <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_',gcm,'_no_cave.tif'))
  batsr.2050.add <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_add_',gcm,'_no_cave.tif'))
  sr.interaction <- batsr.current*0
  #two negative and negative neutral
  sr.interaction[batsr.2050.cl <= batsr.current & batsr.lc.rcp85 <= batsr.current & (batsr.2050.cl + batsr.lc.rcp85 != 2* batsr.current)&
                   batsr.2050.both < batsr.2050.add] <- 1
  ...
  sr.interaction[batsr.2050.cl == batsr.current & batsr.lc.rcp85 == batsr.current &
                   batsr.2050.both > batsr.2050.add] <- 5
  writeRaster(sr.interaction, filename = paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp85_',gcm,'_no_cave.tif'), format="GTiff", overwrite=T)
  print(gcm)
}
...
area.withlcchange.area <- cellStats(area.withlcchange, 'sum')
for(gcm in c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')){
  sr.interaction <- raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp85_',gcm,'_no_cave.tif'))*area.withlcchange
  pro.interaction <- c(cellStats(sr.interaction==1,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==2,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==3,'sum')/area.withlcchange.area*100,
                       cellStats(sr.interaction==4,'sum')/area.withlcchange.area*100,
...
sum.both.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_both_rcp85_no_cave.xlsx')[2:5]
sum.cl.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_cl_rcp85_no_cave.xlsx')[2:5]
sum.lc.sr <- read_excel('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/srchange_lc_rcp85_no_cave.xlsx')[2:3]
names(sum.both.sr) <- c('class','pro.both.median','pro.both.min','pro.both.max')
names(sum.cl.sr) <- c('class','pro.cl.median','pro.cl.min','pro.cl.max')
...
figure <- ggarrange(figure.bar.both,figure.bar.cl,figure.bar.lc,figure.interaction,nrow = 1)
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_interaction_bar_rcp85_no_cave.tiff', 
       units = 'cm', width = 30, height = 8, dpi=300)
# 
#Plot interaction maps
SR.ORG8287 <- CRS('+proj=cea +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs')
...
gcm <- c('ac', 'bc','ca','cm','cn','cs','gf','gi','ip','mi')
sr.interaction <- lapply(gcm, function(x){
  raster(paste0('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/interaction_types_rcp85_',x,'_no_cave.tif'))
})
select.major <- function(x){
  modal(x, na.rm=T, freq=F, ties='random')
}
...
figure.map <- tm_shape(sr.interaction.ensemble,bbox = c(11070729, 943456.3,12186081,  2517140)) +
  ...
  # tm_shape(pas) + tm_polygons(col = 'green', alpha = 0,border.col = 'darkgreen')+
  tm_layout(title = '',title.position = c(0,0.95),legend.position = c(0.1,0.5), frame = F)
tmap_save(figure.map, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/interaction_sr_rcp85_no_cave.tiff',width = 8, height = 10, units = 'cm',dpi = 300)
...
figure.interaction <- sum.range.interaction%>%ggplot(aes(x=factor(class,levels = c('-S','+A','AD','-A','+S')),y=pro.range.interaction.median,fill=class))+
  ...
  theme(text = element_text(size = 14), legend.position = 'none', axis.text = element_text(size = 14))
figure <- ggarrange(figure.both, figure.cl, figure.lc,figure.interaction,nrow = 1)
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/rangesize_change_interaction_rcp85_no_cave.tiff',
       units = 'cm', width = 28, height = 8, dpi = 300)
...
# species.list <- read.xlsx("F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/vnbats_habitat_traits.xlsx", sheetName = 'Sheet1')
# species.list <- species.list%>%select(Scientific_name,Forest,Shrubland,Grassland,Wetlands,Caves,Artificial,Diet.Plant,Diet.Invertebrate)
# species.list.cave <- species.list%>%filter(Caves=='TRUE')
# species.list.nocave <- species.list%>%filter(Caves=="FALSE")
# area.sum.cave <- area.sum%>%filter(Scientific_name%in%species.list.cave$Scientific_name)
# area.sum.nocave <- area.sum%>%filter(Scientific_name%in%species.list.nocave$Scientific_name)
# wilcox.test(area.sum.cave$area.2050.both.median,area.sum.nocave$area.change.both.median , alternative = "two.sided")
# wilcox.test(area.sum.cave$area.change.cl.median,area.sum.nocave$area.change.cl.median , alternative = "two.sided")
# wilcox.test(area.sum.cave$area.change.lc,area.sum.nocave$area.change.lc , alternative = "two.sided")
# 
...
# batsr.2050.both.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_cave.tif')
# batsr.2050.cl.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_cave.tif')
# batsr.2050.lc.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_cave.tif')
# 
...
# batsr.2050.both.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_forest_others.tif')
# batsr.2050.cl.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_forest_others.tif')
# batsr.2050.lc.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_forest_others.tif')
# 
...
# 
# wilcox.test(srchange.both.cave.df$layer,srchange.both.no_cave.df$layer , alternative = "two.sided")
# wilcox.test(srchange.cl.cave.df$layer,srchange.cl.no_cave.df$layer , alternative = "two.sided")
# wilcox.test(srchange.lc.cave.df$layer,srchange.lc.no_cave.df$layer , alternative = "two.sided")
...
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/area change_roosting_rcp85.tiff',
...
batsr.2050.both.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_cave.tif')
batsr.2050.cl.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_cave.tif')
batsr.2050.lc.cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_cave.tif')*area.withlcchange
...
batsr.2050.both.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_both_median_forest_others.tif')
batsr.2050.cl.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_cl_median_forest_others.tif')
batsr.2050.lc.no_cave <- raster('F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/output_maps/batsr_2050_rcp85_lc_forest_others.tif')*area.withlcchange
...
figure <- sum%>%ggplot(aes(x= factor(habitat, levels = c('Cave roosting', 'Others')), y=srchange))+
  ...
  theme(text = element_text(size = 12), axis.text.x = element_text(size = 12), axis.title.y = element_text(size = 14))
# stat_compare_means(aes(label = ..p.signif..), method = 'wilcox.test',label.x = 1.5, label.y = 190,size = 5)#add Wincolson test
ggsave(figure, filename = 'F:/Working/2018/PhD_research/SDM output R/2_6_23_BC_revise/interactive_effects/figures/srchange_roosting_rcp85.tiff',
